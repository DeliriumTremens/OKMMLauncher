...
import com.okmm.android.launcher.FlingGesture.FlingListener;
import com.okmm.android.launcher.LauncherSettings.Favorites;
import com.okmm.android.multitouch.MultiTouchController;
import com.okmm.android.multitouch.MultiTouchController.MultiTouchObjectCanvas;
import com.okmm.android.multitouch.MultiTouchController.PointInfo;
import com.okmm.android.multitouch.MultiTouchController.PositionAndScale;
import com.okmm.android.widget.WidgetSpace;
...
DragScroller, MultiTouchObjectCanvas<Object>, FlingListener {
	...
	private void updateWallpaperOffset(int scrollRange) {
		...
		if (getScrollX() > 0
			...
			mWallpaperManager.setWallpaperOffsets(getWindowToken(), getScrollX()
					/ (float) scrollRange, 0);
		}
	}
	...
	void snapToScreen(int whichScreen) {
		...
		if (mScrollingLoop && (whichScreen == 0) && (mCurrentScreen == maxScreenIndex)) {
			delta = ((mCurrentScreen + 1) * getWidth()) - getScrollX(); // delta
			// should be
			// positive
