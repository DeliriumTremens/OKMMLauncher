...
package com.okmm.android.launcher.catalogue;

import java.util.ArrayList;

import com.okmm.android.launcher.Launcher;
import com.okmm.android.launcher.Workspace;
...
public class AppGroupAdapter extends BaseAdapter {
	...
	private void addListItem(Resources res, AppCatalogueFilters.Catalog catalogue)
	{
	...
	public AppGroupAdapter(Launcher launcher) {
		...
		mItems.add(new ListItem(res, R.string.app_group_add, APP_GROUP_ADD));
		mItems.add(new ListItem(res, R.string.app_group_un, APP_GROUP_ALL));

		for(AppCatalogueFilters.Catalog itm : AppCatalogueFilters.getInstance().getAllGroups()) {
			addListItem(res, itm);
		}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (item.actionTag == APP_GROUP_ALL || item.actionTag == APP_GROUP_ADD) {
