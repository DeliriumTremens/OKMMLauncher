...
import com.okmm.android.launcher.util.XmlUtils;
import com.okmm.android.R.styleable;
import com.okmm.android.R.xml;
...
public class LauncherProvider extends ContentProvider {
	...
	static final String AUTHORITY = "com.okmm.android.settings";

	static final String EXTRA_BIND_SOURCES = "com.okmm.android.settings.bindsources";
	static final String EXTRA_BIND_TARGETS = "com.okmm.android.settings.bindtargets";
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			...
			if (version < 5) {
				db.beginTransaction();
				try {
					ComponentName c=new ComponentName(mContext, CustomShortcutActivity.class);
					db.execSQL("INSERT INTO 'favorites'" +
							...
							"VALUES(" +
							"'Apps'," +
							"'#Intent;action="+CustomShortcutActivity.ACTION_LAUNCHERACTION+";component="+c.flattenToString()+";i.DefaultLauncherAction.EXTRA_BINDINGVALUE=4;end'," +
