...
import com.okmm.android.launcher.LauncherSettings.BaseLauncherColumns;
	...
	void onAddToDatabase(ContentValues values) {
		...
		if (customIcon) {
			...
			if (icon instanceof StateListDrawable){
				// reported crash in developer console
				bitmap = ((FastBitmapDrawable) ((StateListDrawable)icon).getCurrent()).getBitmap();
			} else {
				bitmap = ((FastBitmapDrawable) icon).getBitmap();
			}
